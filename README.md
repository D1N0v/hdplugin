...
Плагін 1.1.1 автоматично запускає найкращу доступну якість. Запам’ятовування фільму, озвучення, сезону й серії вмикається або вимикається в Налаштування → HDRezka → Запам’ятовувати вибір. Озвучення обирається перед запуском відео.
